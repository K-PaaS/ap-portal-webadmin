package org.openpaas.portal.web.admin.config;
 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = "org.openpaas.portal.web.admin.respository", entityManagerFactoryRef = "cfgEntityManager", transactionManagerRef = "cfgTransactionManager")
public class CfgConfig {
    ...
    public LocalContainerEntityManagerFactoryBean cfgEntityManager() {
        ...
        em.setPackagesToScan(new String[]{"org.openpaas.portal.web.admin.entity"});
